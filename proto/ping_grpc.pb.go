...
type PingClient interface {
	...
	IsConnected(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PongReply, error)
}
...
func (c *pingClient) IsConnected(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PongReply, error) {
	out := new(PongReply)
	err := c.cc.Invoke(ctx, "/ping.Ping/IsConnected", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PingServer interface {
	// Sends a connected message
	IsConnected(context.Context, *PingRequest) (*PongReply, error)
...
func (UnimplementedPingServer) IsConnected(context.Context, *PingRequest) (*PongReply, error) {
...
func _Ping_IsConnected_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PingServer).IsConnected(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ping.Ping/IsConnected",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingServer).IsConnected(ctx, req.(*PingRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Ping_IsConnected_Handler,
		},
	},
